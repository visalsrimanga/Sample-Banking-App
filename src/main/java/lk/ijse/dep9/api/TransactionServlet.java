    ...
    private void depositMoney(TransactionDTO transactionDTO, HttpServletResponse response) throws IOException {
        try {
            ...
            try{
                ...
                stmNewTransaction.setString(2, "CREDICT");
...
//            connection.setTransactionIsolation(Connection.TRANSACTION_READ_UNCOMMITTED);
            ...
            try{
                ...
                synchronized (this) {
                    ...
                    if (stmWithdraw.executeUpdate() != 1)
                        throw new SQLException("Failed to update the balance of the from account");
                    ...
                    stmNewTransaction.setTimestamp(5, new Timestamp(new Date().getTime()));
                    if (stmNewTransaction.executeUpdate() != 1)
                        throw new SQLException("Failed to add the credit transaction record");
